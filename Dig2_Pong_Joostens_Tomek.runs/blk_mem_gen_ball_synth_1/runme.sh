...
HD_PWD='D:/Programs/Developing/Dig2_Pong_Joostens_Tomek/Dig2_Pong_Joostens_Tomek.runs/blk_mem_gen_ball_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_ball.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_ball.tcl
