...
#
# Generated by export_simulation on Mon Aug 13 18:03:34 +0200 2018
#
################################################################################
...
switch to the './blk_mem_gen_paddle2.sh' script.

./blk_mem_gen_paddle2.sh -reset_run
...
./blk_mem_gen_paddle2.sh -noclean_files

For more information on the script, please type './blk_mem_gen_paddle2.sh -help'.
