...
#
# Generated by export_simulation on Sat Aug 11 10:59:19 +0200 2018
#
################################################################################
...
switch to the './blk_mem_gen_ball.sh' script.

./blk_mem_gen_ball.sh -reset_run
...
./blk_mem_gen_ball.sh -noclean_files

For more information on the script, please type './blk_mem_gen_ball.sh -help'.
